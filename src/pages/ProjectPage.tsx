...
export function ProjectPage() {
  ...
  const handleOpenSources = () => {
    console.log('[ProjectPage] handleOpenSources called - current tab:', sidebarTab, 'collapsed:', rightSidebar.isCollapsed);
    setSidebarTab('sources');
    if (rightSidebar.isCollapsed) rightSidebar.toggleCollapse();
    console.log('[ProjectPage] handleOpenSources - sidebar should now be open on Sources tab');
  };
