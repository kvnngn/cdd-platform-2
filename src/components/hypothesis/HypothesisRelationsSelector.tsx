...
import { Search, ChevronLeft, ChevronRight, Link as LinkIcon, X } from 'lucide-react';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 border-b border-slate-200">
        ...
        <p className="text-xs text-slate-500">
          Does this hypothesis relate to existing ones? Select hypotheses and define relationship types.
        </p>
      </div>
